...
- **Auth** is invite-only magic links. The allowlist, tokens and sessions live in a second Durable Object. Admins come from the `ADMIN_EMAILS` var and can add or remove people at `/admin`.
