/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 421b19bacca86b729d67eb2af2627eaf)
// Runtime types generated with workerd@1.20260918.1 2025-09-01 nodejs_compat
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	EMAIL: SendEmail;
	ADMIN_EMAILS: "joshua@hu.tt";
	EMAIL_FROM: "i wish it were real <hello@iwishitwerereal.com>";
	SITE_URL: "https://iwishitwerereal.com";
	BOARD: DurableObjectNamespace<import("./worker/index").BoardDurableObject>;
	AUTH: DurableObjectNamespace<import("./worker/index").AuthDurableObject>;
	TLDRAW_DURABLE_OBJECT: DurableObjectNamespace<import("./worker/index").TldrawDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "TldrawDurableObject" | "AuthDurableObject" | "BoardDurableObject";
	}
